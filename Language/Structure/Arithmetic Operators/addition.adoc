...
3. Se os operandos são do tipo de dado float ou double e a variável que armazena armazena a soma é int, então apenas a parte inteira é salva no resultado e e a parte racional é perdida.

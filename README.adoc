...
A tradução da documentação para Português está em progresso e pode ser encontrada nessa https://reference.arduino.cc/reference/pt/[Página]
...
Dentro da pasta Language, a arvore de arquivos segue a mesma estrutura que no link: http://arduino.cc/en/Reference/HomePage[Página antiga da Referência do Arduino (Em Inglês)]

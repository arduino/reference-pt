...
[float]
=== Parâmetros
`result` : variável. *Tipos de dados permitidos:* int, float, double, byte, short, long  +
`numerator` : variável ou constante. *Tipos de dados permitidos:* int, float, double, byte, short, long  +
`denominator` : variável ou constante *diferente de zero*. *Tipos de dados permitidos:* int, float, double, byte, short, long
[%hardbreaks]

...
Consequentemente - para limpar os bits 0 e 1 de um variável, ao mesmo tempo deixando o resto da variável intocado, use o operador de atribuição por bitwise E  (&=) com a constante B11111100
